...
export default function PlantDetailPage() {
  ...
  const waterDaysRemaining = getDaysRemaining(
    plantDetails.lastWatered,
    plantDetails.wateringCycle
  );
  const nutrientDaysRemaining = getDaysRemaining(
    plantDetails.lastFertilized,
    plantDetails.fertilizerCycle
  );
        ...
        <div className="w-full divide-y divide-gray-100">
          ...
          <div className="flex flex-col py-4">
            ...
            <div className="text-center text-sm text-gray-50">
              <p>
                {plantDetails.plantType} • {plantDetails.location}
              </p>
